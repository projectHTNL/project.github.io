...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Ministry Accept Health Center Account</tr>
...
$id=$_GET['vac_id'];
$query="UPDATE healthcentermanager SET Ischecked='1' WHERE id='$id'";
$r= mysqli_query($con,$query);
if(!$r)
{
	
echo"<script type='text/javascript'>\n";
echo"alert('you are not succesflly Accept Health Center acount try again!!!!!');\n";

echo"</script>";
}
else
{echo"<script type='text/javascript'>\n";
echo"alert('you are succesflly Health Center acount!!!!!');\n";
echo"</script>";
}
