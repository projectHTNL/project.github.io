...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Mothers Search Her Vaccinations</tr>
...
$query="SELECT * FROM   patients_vaccinations WHERE patient_id='$motherid'";
...
echo '<td width="100">'.'<font color="Brown" size="3">'."Patient ID".'</font>'.'</td>';
...
echo '<td width="400">'.'<font color="black" size="3">'."$row[3]\n<br>".'</font>'.'</td>';
