...
<table    style="relative:right;top;width:500px;height:210px;" cellspacing="6" cellpadding="0" border="0" bordercolor="#FFFFFF">
 ...
 <td align="left"> <img src="Logo.png" width="150" height="150" id="im1"  ></td>
  ...
  <td align="right" width="400"> <input type="Submit" value="Main functions" onclick="location.href='http://localhost:8080/patientsfunction'" style="background-color:#f8f9fa;font-size:18px; color:#000 " onmouseover="this.style.backgroundColor='#038adc'" onmouseout="this.style.backgroundColor='#f8f9fa'" class="btn1"></td>
...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Patient Check Vaccinations</tr>
...
$query="SELECT * FROM   patients_vaccinations WHERE patient_id='$patient'";
