...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Ministry delete Vaccinations</tr>
...
echo"alert('you are not succesflly Delete Vaccinations try again!!!!!');\n";

echo"</script>";
}
else
{echo"<script type='text/javascript'>\n";
echo"alert('you are succesflly Delete Vaccinations!!!!!');\n";
echo"</script>";
}
