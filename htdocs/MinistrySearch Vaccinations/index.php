...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Ministry Search Vaccinations</tr>
...
echo "<td width='700'><a href='http://localhost:8080/MinistrySearch Vaccinations/delete.php?vac_id=" . $row[0] . "'>Delete</a></td>";
