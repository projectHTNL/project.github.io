...
<table    style="relative:right;top;width:500px;height:210px;" cellspacing="6" cellpadding="0" border="0" bordercolor="#FFFFFF">
 ...
 <td align="left"> <img src="Logo.png" width="150" height="150" id="im1"  ></td>
  ...
  <td align="right" width="400"> <input type="Submit" value="Main functions" onclick="location.href='http://localhost:8080/ministryfunctions'" style="background-color:#f8f9fa;font-size:18px; color:#000 " onmouseover="this.style.backgroundColor='#038adc'" onmouseout="this.style.backgroundColor='#f8f9fa'" class="btn1"></td>
...
<div  align="right"> <!-- Block parent element -->
      <img src="images.jpeg" width="100" height="100"  class="image" >
	 ...
	 <li class="line"></li>
        ...
        <div class="tabs">
          <ul>
            ...
            <li class="sign_in_li">Ministry add Reply</li>
           
          </ul>
        </div>
      
		 <form method="POST" id="form2" Action="addreply.php">
        <div class="sign_up">
            <div class="input_field">
            <Textarea input type="text" placeholder="Add Your Reply" class="input" name="reply" Required></textarea>
          </div>
		 
	
      <div ><input type="submit"  value="Add Reply" class="btn" ></div>
    </div>
