...
<table    style="relative:right;top;width:500px;height:210px;" cellspacing="6" cellpadding="0" border="0" bordercolor="#FFFFFF">
 ...
 <td align="left"> <img src="Logo.png" width="150" height="150" id="im1"  ></td>
  ...
  <td align="center" width="400"> <input type="Submit" value="Main functions" onclick="location.href='http://localhost:8080/Healthcentermanagerfunctions'" style="background-color:#f8f9fa;font-size:18px; color:#000 " onmouseover="this.style.backgroundColor='#038adc'" onmouseout="this.style.backgroundColor='#f8f9fa'" class="btn1"></td>
...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Health Center Accept Staff Account</tr>
...
$id=$_GET['id'];
$query="UPDATE healthcenterstaff SET Ischecked='1' WHERE jobid='$id'";
$r= mysqli_query($con,$query);
if(!$r)
{
	
echo"<script type='text/javascript'>\n";
echo"alert('you are not succesflly Accept Health Center staff acount try again!!!!!');\n";

echo"</script>";
}
else
{echo"<script type='text/javascript'>\n";
echo"alert('you are succesflly Accept Health Center staff acount!!!!!');\n";
echo"</script>";
}
