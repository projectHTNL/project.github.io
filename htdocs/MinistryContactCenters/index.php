...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Ministry contact centers</tr>
...
$query="SELECT * FROM   healthcentercontactministry WHERE recieve IS NULL";
$r= mysqli_query($con,$query);
if(!$r)
{
echo"<script type='text/javascript'>\n";
echo"alert('you are not succesflly Search HELTH CENTER NESSAGES try again!!!!!');\n";
echo"</script>";
}
else
{echo"<script type='text/javascript'>\n";
echo"alert('you are succesflly Search HELTH CENTER NESSAGES!!!!!');\n";
echo"</script>";
}
...
echo '<td width="100">'.'<font color="Brown" size="3">'."Send".'</font>'.'</td>';
echo '<td width="100">'.'<font color="Brown" size="3">'."Recieve".'</font>'.'</td>';
...
echo "<td width='700'><a href='http://localhost:8080/Ministryaddreplytocenter/index.php?id=" . $row[0] . "'>Add Reply</a></td>";
